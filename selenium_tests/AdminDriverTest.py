...
class AdminDriverTest(RemoteAppDriverTest):
    ...
    def click_submit_button(self):
        self.click_first_element_located(By.XPATH, "//button[contains(text(),'Submit')]")
        self.wait_until_modal_closed()

    def click_ok_button(self):
        self.click_first_element_located(By.XPATH, "//button[contains(text(),'Ok')]")
        self.wait_until_modal_closed()

    def click_cancel_button(self):
        self.click_first_element_located(By.XPATH, "//button[contains(text(),'Cancel')]")
        self.wait_until_modal_closed()
